...
`terraform apply` also requests a `g6.xlarge` one-time Spot instance in `us-west-2`. It uses the current Amazon Linux 2023 AMI. Spot capacity is not guaranteed, and AWS can interrupt and terminate the instance.
